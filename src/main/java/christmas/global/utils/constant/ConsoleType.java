...
public enum ConsoleType {
    ...
    OUTPUT_MENU_OF_ORDER("<주문 메뉴>"),
    OUTPUT_TOTAL_OF_ORDER_BEFORE_DISCOUNT("<할인 전 총주문 금액>"),
    OUTPUT_MENU_OF_EVENT("<증정 메뉴>"),
    OUTPUT_LIST_OF_DISCOUNT("<혜택 내역>"),
    ...
    OUTPUT_TOTAL_OF_DISCOUNT("<총혜택 금액>"),
    OUTPUT_TOTAL_OF_AFTER_DISCOUNT("<할인 후 예상 결제 금액>"),
